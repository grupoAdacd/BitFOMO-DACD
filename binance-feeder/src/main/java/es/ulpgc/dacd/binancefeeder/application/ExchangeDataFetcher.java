package es.ulpgc.dacd.binancefeeder.application;


import es.ulpgc.dacd.binancefeeder.domain.ExchangeDataProvider;
import es.ulpgc.dacd.binancefeeder.adapters.HttpClient;
